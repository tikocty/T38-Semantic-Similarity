...
"""
NOTE:
by changing the model from 'en_core_web_md' to ‘en_core_web_sm’, 
the warning msg shown as: UserWarning: [W007] The model you're using has no word vectors loaded, 
...
besides that the similarity rate is much lower than using model 'en_core_web_md'
I think it is because en_core_web_sm is not senseitive enough to compare the data
"""
